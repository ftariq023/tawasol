    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          border: isSearchScreenBorder ? InputBorder.none : OutlineInputBorder(borderSide: isShowBorder ? BorderSide(color: Colors.grey.shade400) : const BorderSide(color: Colors.white), borderRadius: BorderRadius.circular(isLoginPage ? 18 : 8)),
